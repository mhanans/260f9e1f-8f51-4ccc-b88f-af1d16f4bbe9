...
function install_dependencies() {
    if pip list 2>/dev/null | grep -q "kotaemon"; then
        ...
        sudo apt update
        sudo apt install unixodbc unixodbc-dev tesseract-ocr tesseract-ocr-ind libtesseract-dev poppler-utils
        python -m pip install docling pyodbc psycopg2-binary faiss-cpu
...
print_highlight "Launching AccelistLLM in your browser, please wait..."
